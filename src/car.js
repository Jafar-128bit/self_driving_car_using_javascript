class Car {
  constructor(x, y, width, height, controlType, maxSpeed = 3) {
    ...
    if (controlType !== 'DUMMY') {
      ...
      this.brain = new NeuralNetwork([this.sensor.rayCount, 11, 6, 4]);
    }
  ...
  #move() {
    ...
    /* Left and Right turning controls */
    if (this.speed !== 0) {
  ...
  info() {
    /*Return all the values of car for info display*/
    return {
      positionX: this.x,
      positionY: this.y,
      speed: this.speed,
